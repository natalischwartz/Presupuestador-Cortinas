    ...
    return {
      ...
      servicios: {
        ...
        detalle: {
          ...
          rieles: calc.rieles?.calculo || `${calc.rieles?.cantidadVentanas || presupuesto.cantidadVentanasRiel || 1} ventana(s) × ${calc.rieles?.metrosPorVentana || presupuesto.metrosPorVentana || (calc.windowWidth || 1.4).toFixed(2)} m`,
